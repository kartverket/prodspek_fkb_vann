...
F&#248;ringene om fullstendighet gjelder uavhengig av om det er bestilt opsjoner Stikkrenne og/eller Kulvert i FKB-BygnAnlegg. Dette inneb&#230;rer at vannveger under bakken i stikkrenner og kulverter skal registreres b&#229;de i FKB-Vann med medium U, og i FKB-BygnAnlegg n&#229;r disse opsjonene er bestilt. Dette for at vannettverket skal bli registrert sammenhengende i FKB-Vann.
...
image::figurer/vann_stikkrenner.png[link=figurer/vann_stikkrenner.png, Alt="Eksempel på vannobjekt med medium U registrert sammen med stikkrenne"]
...
MEDIUM U benyttes p&#229; KanalGr&#248;ft som ligger under terreng, for eksempel under veg. Skal ikke benyttes ved bruer. Se eksempel p&#229; registrering av vannobjekt med medium U sammen med Stikkrenne under objekttype ElvBekk
...
[discrete]
==== Tilleggsinformasjon for fotogrammetrisk registrering
Ved fotogrammetrisk datafangst *skal* vann som renner gjennom demning alltid registreres som objekttype _KonnekteringVann_ og medium B. Utover dette skal objekttype _KonnekteringVann_ kun registreres fotogrammetrisk der det er avtalt spesielt.
